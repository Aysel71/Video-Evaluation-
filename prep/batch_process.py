...
def batch_process(videos_dir, subtitles_dir, output_dir, num_frames=16):
    ...
    for video_file in sorted(video_files):
        ...
        summary["videos"].append({
            ...
            "frames_with_subtitles": num_frames - missing_subs,
...
if __name__ == "__main__":
    ...
    batch_process(videos_dir, subtitles_dir, output_dir, num_frames=16)
